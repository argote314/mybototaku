...
* (Scriptnya FADHIL GRAPHY)
* jangan ubah semuanya kecuali nama bot instagram yt itu ajah yg lain jangan!!!
* UBAH AJA SEMAU KALIAN, GW BAIK:VV
*/
const XPTN = '🔰_MYBOT_🔰'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/nur.fdhl_'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://wa.me/6283102650464'; // JANGAN DI UBAH NANTI EROR
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @mybotv3`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @mybotv3`)
})
